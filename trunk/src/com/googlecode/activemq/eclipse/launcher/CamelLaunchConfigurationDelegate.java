package com.googlecode.activemq.eclipse.launcher;
 ...
 */
public class CamelLaunchConfigurationDelegate extends AbstractJavaLaunchConfigurationDelegate implements ILaunchConfigurationDelegate {

	public static final String LAUNCH_CONFIG_TYPE_ID = "com.googlecode.activemq.eclipse.launchConfigurationType";
	...
	public void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor) throws CoreException {
		...
		// TODO we need to deal properly with arguments and vmargs containing a
		// list of arguments
		...
		// TODO we need to set the project to be the currently active project to
		// see the classpath
		// of local stuff
		...
		try {
			...
			// "org.apache.camel.spring.Main.getInstance()";
