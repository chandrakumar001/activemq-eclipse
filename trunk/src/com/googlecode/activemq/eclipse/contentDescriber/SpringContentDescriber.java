package com.googlecode.activemq.eclipse.contentDescriber;
 ...
 * reference:org.eclipse.ant.internal.core
 * .contentDescriber.AntBuildfileContentDescriber
 */
public class SpringContentDescriber extends XMLContentDescriber implements IExecutableExtension {

	/*
	 * (Intentionally not included in javadoc) Determines the validation status
